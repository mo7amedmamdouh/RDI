<!-- Header
============================================= -->
<div id="wrapper" class="clearfix" style="animation-duration: 1500ms; opacity: 1; background-image: url({{asset('images/siteImages/sliderBackground.jpg')}})">
          ...
          <nav id="primary-menu" class="dark">
            ...
            <ul>
              ...
              <li><a href="#"><div>OCR Tech</div></a>
                <ul>
                  <li><a href="{{route('typeWritten')}}"><div>Typewritten</div></a></li>
                  <li><a href="{{route('handWritten')}}"><div>Handwritten</div></a></li>
                </ul>
              </li>
